...
import com.simplilearn.workshop.repository.PurchaseReportRepository;
import com.simplilearn.workshop.repository.ShoesRepository;
import com.simplilearn.workshop.service.SportyShoesService;
...
public class SportyShoesServiceImpl implements SportyShoesService{
	...
	@PostConstruct
	public void init() {
		Shoe s1 = new Shoe(1,"Shoe Name 1","VollyBall",1000.24);
		Shoe s2 = new Shoe(2,"Shoe Name 2","Cricket",1100.24);
		Shoe s3 = new Shoe(3,"Shoe Name 3","Basketball",900.24);
		...
		Date d = new Date(0);
		PurchaseReport pr1 = new PurchaseReport(5,"user_1","VolleyBall",d,"adidas_volleyball:5,nike_volleyball:10");
